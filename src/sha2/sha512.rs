...
pub(crate) mod args {
    ...
    pub(crate) type MessageLen = u128;

    pub(crate) const N_DIGEST_BYTES: usize = 64; // 512 bits
    pub(crate) const N_ROUNDS: usize = 80;
    pub(crate) const N_CHUNK_BYTES: usize = 128; // 1024 bits
...
crate::test_macros::define_hash_tests!(
    ...
    [
        0xb4, 0x7c, 0x93, 0x34, 0x21, 0xea, 0x2d, 0xb1, 0x49, 0xad, 0x6e, 0x10, 0xfc, 0xe6, 0xc7,
        0xf9, 0x3d, 0x07, 0x52, 0x38, 0x01, 0x80, 0xff, 0xd7, 0xf4, 0x62, 0x9a, 0x71, 0x21, 0x34,
        0x83, 0x1d, 0x77, 0xbe, 0x60, 0x91, 0xb8, 0x19, 0xed, 0x35, 0x2c, 0x29, 0x67, 0xa2, 0xe2,
        0xd4, 0xfa, 0x50, 0x50, 0x72, 0x3c, 0x96, 0x30, 0x69, 0x1f, 0x1a, 0x05, 0xa7, 0x28, 0x1d,
        0xbe, 0x6c, 0x10, 0x86,
    ]
);
