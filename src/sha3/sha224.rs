...
pub fn hash(message: &[u8]) -> Digest<28> {
    Digest::from_bytes(keccak::<28>(144, message, 0x06).unwrap())
}
...
mod tests {
    ...
    define_hash_tests!(
        ...
        [
            0xc6, 0xd6, 0x6e, 0x77, 0xae, 0x28, 0x95, 0x66, 0xaf, 0xb2, 0xce, 0x39, 0x27, 0x77,
            0x52, 0xd6, 0xda, 0x2a, 0x3c, 0x46, 0x01, 0x0f, 0x1e, 0x0a, 0x09, 0x70, 0xff, 0x60,
        ]
    );
}
